"""
Django settings for green_moon_42509 project.
...
ROOT_URLCONF = 'green_moon_42509.urls'
...
WSGI_APPLICATION = 'green_moon_42509.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "green_moon_42509 API",
    "DESCRIPTION": "API documentation for green_moon_42509 App",
    "VERSION": "v1",
}
